    ...
    <div>
      ...
      <div class="relative">
        <input
          type="text"
          v-model="errorEmail"
          class="dark:bg-dark-900 w-full rounded-lg border border-error-300 bg-transparent px-4 py-2.5 pr-10 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-error-300 focus:outline-hidden focus:ring-3 focus:ring-error-500/10 dark:border-error-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-error-800 rtl:pr-4 rtl:pl-10"
        />
        <span class="absolute right-3.5 top-1/2 -translate-y-1/2 rtl:right-auto rtl:left-3.5">
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
