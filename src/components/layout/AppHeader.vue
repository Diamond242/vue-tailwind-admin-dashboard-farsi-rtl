  ...
  >
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
      ...
      >
        <button
          @click="handleToggle"
          class="flex items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 lg:border rtl:order-1 lg:rtl:order-none"
          :class="[
            isMobileOpen
        ...
        <HeaderLogo class="rtl:order-2 lg:rtl:order-none" />
        <button
          @click="toggleApplicationMenu"
          class="flex items-center justify-center w-10 h-10 text-gray-700 rounded-lg z-99999 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden rtl:order-3"
        >
          <svg
            width="24"
            height="24"
