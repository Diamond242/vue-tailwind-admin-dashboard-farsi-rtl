                ...
                <div class="space-y-5">
                  <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                      ...
                      >
                        {{ t('auth.signup.firstNameLabel') }}<span class="text-error-500">*</span>
                      </label>
                      <input
                        v-model="firstName"
                        type="text"
                    ...
                    <div class="sm:col-span-1">
                      <label
                        ...
                        class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                      >
                        {{ t('auth.signup.lastNameLabel') }}<span class="text-error-500">*</span>
                      </label>
                      <input
                        v-model="lastName"
                        type="text"
                  ...
                  <div>
                    <label
                      ...
                      class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                    >
                      {{ t('auth.signup.emailLabel') }}<span class="text-error-500">*</span>
                    </label>
                    <input
                      v-model="email"
                      type="email"
                  ...
                  <div>
                    <label
                      ...
                      class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                    >
                      {{ t('auth.signup.passwordLabel') }}<span class="text-error-500">*</span>
                    </label>
                    <div class="relative">
                      <input
                        v-model="password"
              ...
              <div class="mt-5">
                ...
                >
                  ...
                  <router-link
                    ...
                    >{{ t('auth.signup.signinLink') }}</router-link
                  >
                </p>
              </div>
            </div>
