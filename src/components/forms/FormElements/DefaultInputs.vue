  ...
  <div class="space-y-6">
    ...
    <div>
      ...
      <div class="relative z-20 bg-transparent">
        <select
          ...
          class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 rtl:pr-4 rtl:pl-11"
        ...
        <span
          class="absolute z-30 text-gray-500 -translate-y-1/2 pointer-events-none right-4 top-1/2 dark:text-gray-400 rtl:right-auto rtl:left-4"
        >
          <svg
    ...
    <div>
      ...
      <div class="relative">
        ...
        <span
          ...
          class="absolute z-30 -translate-y-1/2 cursor-pointer right-4 top-1/2 rtl:right-auto rtl:left-4"
        >
          <svg
            v-if="!showPassword"
    ...
    <div>
      ...
      <div class="relative">
        ...
        />
        <span
          class="absolute text-gray-500 -translate-y-1/2 pointer-events-none right-3 top-1/2 dark:text-gray-400 rtl:right-auto rtl:left-3"
        >
          <svg
            class="fill-current"
            width="20"
    ...
    <div>
      ...
      <div class="relative">
        ...
        />
        <span class="absolute text-gray-500 -translate-y-1/2 right-3 top-1/2 dark:text-gray-400 rtl:right-auto rtl:left-3">
          <svg
            class="fill-current"
            width="20"
            height="20"
...
import { buildSingleDateConfig, getFlatpickrLocale } from '@/utils/flatpickr'
...
const flatpickrTimeConfig = computed(() => ({
  ...
  minuteIncrement: 1,
  wrap: false,
  ...(locale.value === 'fa' ? { position: 'auto right' } : {}),
}))
